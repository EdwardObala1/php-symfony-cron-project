...
final class Version20230920081255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE experiences (id INT NOT NULL, title TEXT NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, location TEXT NOT NULL, remote BOOLEAN NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
